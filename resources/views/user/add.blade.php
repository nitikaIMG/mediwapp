        ...
        <form class="forms-sample" method="POST" action="{{route('user.store')}}" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="user_firstname" class="form-control"  value="{{old('user_firstname')}}" id="exampleInputName1"  placeholder=" User Name">
                </div>
                <div class="form-group col-md-6">
                    <label for="exampleInputName1">Last Name</label>
                    <input type="text" name="user_lastname" class="form-control"  value="{{old('user_lastname')}}" id="exampleInputName1"  placeholder=" User Name">
                </div>
            </div>
            <div class="row">
                <div class="form-group col-md-6">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="user_phonenumber" class="form-control"  value="{{old('user_phonenumber')}}" id="exampleInputName1"  placeholder=" User Name">
                </div>
            </div>
